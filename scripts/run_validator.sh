...
# uv venv --python 3.11 /lustre/utmp/std/uv_envs/mlcast_validator_py311

# # 5) Activarlo
# source /lustre/utmp/std/uv_envs/mlcast_validator_py311/bin/activate
...
mlcast.validate_dataset source_data radar_precipitation /perm/pred/std/ML/MLCAST/mlcast-dataset-ES-AEMET-reflectivity/ES-AEMET-radar_reflectivity-ppi_ZAR_2020-2023_2.zarr
#mlcast.validate_dataset source_data radar_precipitation /lustre/utmp/std/MLCAST_radar_data/outputs/monthly_v3/radar_2022_11.zarr